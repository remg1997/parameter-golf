...
def main():
    ...
    # [exp] relaxed: bigbag's `8 % world_size != 0` check ruled out ws=3, but
    # 8//3=2 is integral and 786432/(3*2)=131072 tokens/micro-batch is exact.
    # Total batch is preserved; only micro-batch count differs (6 vs 8).
